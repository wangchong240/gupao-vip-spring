    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        try{
            ...
            for (String className : mapping.keySet()) {
                ...
                if(clazz.isAnnotationPresent(WCController.class)){
                    mapping.put(className,clazz.newInstance());
                    String baseUrl = "";
                    if (clazz.isAnnotationPresent(WCRequestMapping.class)) {
                        WCRequestMapping requestMapping = clazz.getAnnotation(WCRequestMapping.class);
                ...
                }else if(clazz.isAnnotationPresent(WCService.class)){
                        WCService service = clazz.getAnnotation(WCService.class);
            ...
            for (Object object : mapping.values()) {
                ...
                if(clazz.isAnnotationPresent(WCController.class)){
                    ...
                    for (Field field : fields) {
                        ...
                        WCAutowired autowired = field.getAnnotation(WCAutowired.class);
